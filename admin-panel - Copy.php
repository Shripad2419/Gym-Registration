    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="admin-panel.php" class="list-group-item"> Add Member</a>
        </div>
        <hr>
        <div class="list-group">
      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <form class="form-group" style="margin: 0px 15px 32px;" action="func.php" method="post">
            ...
            <div>
            <button type="submit" id="reg_btn" name="mem_submit" class="btn btn-primary" onclick="return validate()">Register</button>
          </div>
        </form>
        </div>
      </div>
